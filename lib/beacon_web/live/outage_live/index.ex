  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      ...
      >
        ...
        <:col :let={{_id, outage}} label="Estimated restoration time">{outage.estimated_restoration_time}</:col>
        <:col :let={{_id, outage}} label="Actual restoration time">{outage.actual_restoration_time}</:col>
